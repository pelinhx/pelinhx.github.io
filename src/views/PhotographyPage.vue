    ...
    <section class="portfolio-gallery">
      <div class="container">
        ...
        <div class="gallery-grid">
          <div v-for="photo in filteredPhotos" :key="photo.id" class="gallery-item" @click="openInstagramPost(photo.link)">
            <div class="photo-aspect-ratio">
              <div class="photo-thumbnail" :style="{ backgroundImage: `url(${photo.thumbnail})` }">
...
/* Gallery Grid Styling - Updated to 3 columns with 3:4 aspect ratio */
.gallery-grid {
  display: grid;
...
/* Aspect ratio container for 3:4 images */
.photo-aspect-ratio {
  position: relative;
  width: 100%;
  padding-bottom: 133.33%; /* 3:4 aspect ratio (3/4 = 0.75, so 1/0.75 = 1.3333...) */
  overflow: hidden;
}
...
.photo-info h3 {
  ...
  font-size: 1rem; /* Slightly smaller for 3-column layout */
  font-weight: 500;
}
